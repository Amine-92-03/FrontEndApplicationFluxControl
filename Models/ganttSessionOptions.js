export default function ganttConfig(LabelY, LabelXJ,LabelXJ_1,progressData,progressDataJ_1,sizeY){
    return{
        type: 'bar',
        data: {
            labels: LabelY,
        ...
        options: {
            ...
            scales: {
                ...
                x: {
                    ...
                    parsing:false,
                    min: ()=>{
                        // console.log('Debut',dateLong(LabelXJ[0][0]));
                        return LabelXJ[0][0]
                    },
                    max:()=>{    
                        // console.log(dateLong(LabelXJ[LabelXJ.length-1][1])); 
                        return LabelXJ[LabelXJ.length-1][1]
                    },
                    position: 'top',
                    type: 'time',
                    time: {
